...
- A derived figure is not a recorded amount and may be negative: an Account's running balance can be overdrawn. The peso formatter therefore keeps a minus sign rather than rejecting one.
